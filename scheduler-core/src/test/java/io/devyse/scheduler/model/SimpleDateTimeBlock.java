...
public class SimpleDateTimeBlock extends AbstractDateTimeBlock{
	...
	/**
	 * Create a new SimpleDateTimeBlock using the zoned times
	 *
	 * @param dow the day of the week
	 ...
	 * @param endDate the end date
	 */
	protected SimpleDateTimeBlock(DayOfWeek dow, OffsetTime startTime, OffsetTime endTime, LocalDate startDate, LocalDate endDate) {
